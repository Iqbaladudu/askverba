            ...
            {data.length === 0 ? (
              ...
              data.map((record, index) => (
                <React.Fragment key={String(record.id || record.key || index)}>
                  <TableRow
                    className={size === 'small' ? 'h-8' : size === 'large' ? 'h-16' : 'h-12'}
                  >
                    {rowSelection && (
                      <TableCell>
                        <input
                          ...
                          checked={rowSelection.selectedRowKeys.includes(
                            String(record.id || record.key || index),
                          )}
                          onChange={(e) => {
                            ...
                            if (e.target.checked) {
                              ...
                              rowSelection.onChange(
                                ...
                                data.filter(
                                  (_, i) => String(data[i].id || data[i].key || i) !== key,
                                ),
                              )
                            }
                          }}
                    ...
                    {expandable && (
                      <TableCell>
                        <Button variant="ghost" size="sm" onClick={() => handleExpand(record)}>
