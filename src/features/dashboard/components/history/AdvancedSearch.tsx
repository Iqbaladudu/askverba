        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleFilterChange('minCharacters', e.target.value ? parseInt(e.target.value) : undefined)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleFilterChange('maxCharacters', e.target.value ? parseInt(e.target.value) : undefined)}
            />
          </div>
        </div>
