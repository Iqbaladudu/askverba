    ...
    <div className="container mx-auto p-4 space-y-4">
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>This page tests the vocabulary creation functionality that would be used when saving vocabulary from detailed translations.</p>
          ...
          <Button 
            onClick={testVocabularyCreation} 
            disabled={loading}
            className="w-full"
          >
