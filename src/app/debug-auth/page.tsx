      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            <Button onClick={clearAllCookies} variant="destructive">Clear All Cookies</Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p><strong>Has Customer:</strong> {customer ? 'Yes' : 'No'}</p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p><strong>Has Direct Token:</strong> {cookieData?.hasDirectToken ? 'Yes' : 'No'}</p>
                  <p><strong>Has Direct Customer:</strong> {cookieData?.hasDirectCustomer ? 'Yes' : 'No'}</p>
                  {cookieData?.directToken && (
                    <p><strong>Direct Token Length:</strong> {cookieData.directToken.length}</p>
                  )}
                  {cookieData?.directCustomer && (
                    <div>
                      <p><strong>Direct Customer Email:</strong> {cookieData.directCustomer.email}</p>
                      <p><strong>Direct Customer Name:</strong> {cookieData.directCustomer.name}</p>
                    </div>
                  )}
                </div>
              </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <p>5. If cookies exist but auth context shows not authenticated, there's a parsing issue</p>
              </div>
            </CardContent>
          </Card>
        </CardContent>
