            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p><strong>Vocabulary Count:</strong> {vocabulary?.length || 0}</p>
                  <p><strong>Stats:</strong> {stats ? JSON.stringify(stats, null, 2) : 'None'}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p><strong>API Vocabulary Count:</strong> {debugInfo?.vocabulary?.count || 0}</p>
                  <p><strong>All Vocabulary Count:</strong> {debugInfo?.allVocabulary?.count || 0}</p>
                </div>
              </CardContent>
            </Card>
          </div>
                  ...
                  {vocabulary.map((item: any, index: number) => (
                    <div key={index} className="p-2 border rounded bg-gray-50">
                      ...
                      <small className="text-gray-600">
                        Status: {item.status} | Difficulty: {item.difficulty} | Created: {new Date(item.createdAt).toLocaleDateString()}
                      </small>
                    </div>
                  ))}
                </div>
